const portfolioData = [
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/site/2147579735/images/8xV6q8v1QB6T4NX5taKF_Core_Values_Workshop.png",
  ...
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/site/2147579735/images/TQrLDMMQXDb0IbKTJRIw_Core_Values_Workshop_12.png",
  ...
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/site/2147579735/images/eJwL4sILQHKtUIqgo9gc_Website_Kajabi_Workshop_Design_5_copy.png",
  ...
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/site/2147579735/images/044ae40-051d-4430-8d70-78654db36f5_Exclusive_Socials_--_Kajabi_8_.png",
  ...
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/site/2147579735/images/34b2ec-7cc4-0e4c-82a3-fcf8d5082f2_Exclusive_Socials_--_Kajabi_11_.png",

    title: "Deep Learning and Bitcoins and other.",
    description:
  ...
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/file-uploads/site/2147579735/images/6406eb4-cf8-585b-c1a-2a7e443541b_Exclusive_Socials_--_Kajabi_18_.png",

    title: "E-banking system for Smart Sacco ",
    description:
...

  {
    ...
    title: "Airbnb backend management system",
    description:
      "Developed a comprehensive data quality dashboard for Delta Lloyd, focusing on data engineering and data analysis to ensure high data standards.",
    description2:
      "The project involved creating an ETL pipeline and performing in-depth business data analysis to improve data reliability and insights.",
  ...
  {
    img: "https://kajabi-storefronts-production.kajabi-cdn.com/kajabi-storefronts-production/site/2147579735/images/TQrLDMMQXDb0IbKTJRIw_Core_Values_Workshop_12.png",
    title: "Router Password changing portal",
    description:
      "Conducted a detailed analysis of life expectancy data, focusing on differences between countries and genders, highlighting the impact of lifestyle and risks.",
    description2:
      "Visualized the data to reveal significant trends, such as the 6-year life expectancy gap between men and women in Japan.",
 ...
 
  {
    ...
    title: "Predicting the rate of cancer in Kenya",
    description:
      "Developed a machine learning model to predict the number of comments on Reddit posts based on various features such as post title, subreddit, and time of posting.",
    description2:
      "Utilized data visualization techniques to explore and present insights about comment trends and user engagement on the platform.",
  ...
  },
  {
    ...
    title: "Course buying and selling system",
    description:
      "Created a deep learning model to predict Bitcoin price trends using historical data, news sentiment analysis, and technical indicators.",
    description2:
      "Developed an interactive web application for real-time Bitcoin price prediction and visualization, providing users with actionable insights.",
  ...
  },
  {
    ...
    title: "Interactive Bot for Downloading movies on telegram",
    description:
      "Developed a comprehensive SQL tutorial platform to teach users SQL basics and advanced query techniques through interactive lessons and exercises.",
    description2:
      "Incorporated real-time code execution and feedback to enhance the learning experience and provide practical knowledge in database management.",
